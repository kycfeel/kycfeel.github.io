...
2018.06 ~ 현재 [bitHolla](https://bitholla.com)의 DevOps 엔지니어로 근무 중. AWS와 DigitalOcean에서 구동되는 자사 서비스의 서비스 유지보수, 테스트와 프로덕션 환경 구축, 유지보수, Docker를 사용하는 애플리케이션 배포 담당 중. 컨테이너의 완전한 오케스트레이션과 배포 자동화를 궁극적인 목표로 삼고 있음. Grafana를 사용하는 모니터링 대시보드 구축. 자체 ETH 노드 구축. 현재 모든 서비스 환경을 Kubernetes로 마이그레이션 중.
